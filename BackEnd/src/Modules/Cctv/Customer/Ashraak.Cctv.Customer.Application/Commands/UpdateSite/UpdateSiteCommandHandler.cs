...
internal sealed class UpdateSiteCommandHandler(
    ...
    IUnitOfWork unitOfWork) : IRequestHandler<UpdateSiteCommand, Result<SiteDetailDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            site.UpdateDetails(request.Name, request.Address, request.City, request.UserId);
        }
