...
internal sealed class GetSiteContactsQueryHandler(
    ISiteRepository repository,
    IAuthPermissionChecker permissionChecker,
    IFeatureFlagService featureFlags) : IRequestHandler<GetSiteContactsQuery, Result<IReadOnlyList<SiteContactDto>>>
{
    public async Task<Result<IReadOnlyList<SiteContactDto>>> Handle(
        GetSiteContactsQuery request,
