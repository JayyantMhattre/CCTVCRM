...
internal sealed class GetContractDocumentsQueryHandler(
    IAmcContractRepository contractRepository,
    IAuthPermissionChecker permissionChecker,
    IFeatureFlagService featureFlags) : IRequestHandler<GetContractDocumentsQuery, Result<IReadOnlyList<AmcContractDocumentDto>>>
{
    public async Task<Result<IReadOnlyList<AmcContractDocumentDto>>> Handle(
        GetContractDocumentsQuery request,
