...
internal sealed class SubmitVisitReportCommandHandler(
    ...
    IUnitOfWork unitOfWork) : IRequestHandler<SubmitVisitReportCommand, Result<VisitDetailDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            visit.SubmitReport(request.UserId);
        ...
        {
            return Error.Validation("Visits.SubmitFailed", ex.Message);
        }
    }
}
