...
internal sealed class GetEngineerTodaySchedulesQueryHandler(
    ...
    IFeatureFlagService featureFlags) : IRequestHandler<GetEngineerTodaySchedulesQuery, Result<IReadOnlyList<ScheduleSummaryDto>>>
{
    public async Task<Result<IReadOnlyList<ScheduleSummaryDto>>> Handle(
        GetEngineerTodaySchedulesQuery request,
