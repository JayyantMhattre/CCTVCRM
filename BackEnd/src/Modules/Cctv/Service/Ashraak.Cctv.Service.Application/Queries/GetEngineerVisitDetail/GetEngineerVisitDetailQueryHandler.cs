...
internal sealed class GetEngineerVisitDetailQueryHandler(
    ...
    IFeatureFlagService featureFlags) : IRequestHandler<GetEngineerVisitDetailQuery, Result<VisitDetailDto>>
{
    public async Task<Result<VisitDetailDto>> Handle(
        GetEngineerVisitDetailQuery request,
