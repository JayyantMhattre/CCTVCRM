...
export default function PortalProfilePage() {
  return (
    <div>
      <PageHeader title="Profile" subtitle="Platform account settings" />
      ...
      <div className="row g-3">
        ...
        <div className="col-md-6">
          <div className="card border-0 shadow-sm h-100">
            <div className="card-body">
              <h2 className="h6 fw-semibold">Password reset</h2>
              <p className="text-muted small">
                Reset your password using email OTP verification.
              </p>
              <Link to={ROUTES.forgotPassword} className="btn btn-sm btn-outline-primary">
                Forgot password
              </Link>
            </div>
          </div>
